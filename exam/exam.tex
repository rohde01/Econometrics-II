...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (1) -- Reduced-form impulse responses}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (2) -- OLS consistency under conditional heteroskedasticity}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (3) -- Unconditional variance in the ARCH-X model}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (4) -- Conditional joint density and log-likelihood}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (5) -- Multi-step conditional variance forecasts}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (6) -- GMM under non-Gaussian $z_t$}
% ─────────────────────────────────────────────────────────────────────────────
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Question (7) -- Testing $H_0:\gamma=0$}
% ─────────────────────────────────────────────────────────────────────────────
